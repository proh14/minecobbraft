...
import net.minecobbraft.block.custom.ComposingTableBlock;
...
public class ModBlocks {
  ...
  public static final Block COMPOSING_TABLE = registerBlock("composing_table", new ComposingTableBlock(Block.Settings.copy(Blocks.IRON_BLOCK).nonOpaque()));
