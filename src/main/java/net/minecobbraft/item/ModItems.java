...
public class ModItems {
  ...
  public static final Item RUST_CRAB_SPAWN_EGG = registerItem("rust_crab_spawn_egg", new SpawnEggItem(ModEntities.RUST_CRAB, 0xFFFFFF, 0xFF8C00, new Item.Settings()));
