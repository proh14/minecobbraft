...
public class ModModelProvider extends FabricModelProvider {
  ...
  public void generateItemModels(ItemModelGenerator itemModelGenerator) {
    ...
    itemModelGenerator.register(ModItems.CANO, Models.GENERATED);
    ...
    itemModelGenerator.register(ModItems.DETECTIVEKAKTUS_SPAWN_EGG,
      new Model(Optional.of(Identifier.of("item/template_spawn_egg")), Optional.empty()));
    itemModelGenerator.register(ModItems.LOCALTEXAN_SPAWN_EGG,
      new Model(Optional.of(Identifier.of("item/template_spawn_egg")), Optional.empty()));
    itemModelGenerator.register(ModItems.PROH14_SPAWN_EGG,
      new Model(Optional.of(Identifier.of("item/template_spawn_egg")), Optional.empty()));
    itemModelGenerator.register(ModItems.TSODING_SPAWN_EGG,
      new Model(Optional.of(Identifier.of("item/template_spawn_egg")), Optional.empty()));
  }
}
