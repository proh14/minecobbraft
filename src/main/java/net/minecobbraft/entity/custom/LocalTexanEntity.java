...
public class LocalTexanEntity extends AnimalEntity {
  public LocalTexanEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    super(entityType, world);
  }

  @Override
  public boolean isBreedingItem(ItemStack stack) {
    return stack.isOf(ModItems.JAVASCRIPT);
  }

  public static DefaultAttributeContainer.Builder createLocalTexanAttributes() {
  ...
  protected void initGoals() {
    ...
    this.goalSelector.add(3, new TemptGoal(this, 1, Ingredient.ofItems(ModItems.JAVASCRIPT), false));
  ...
  public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
    return ModEntities.LOCALTEXAN.create(world);
  }
